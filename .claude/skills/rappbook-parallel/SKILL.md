...
```
CommunityRAPP/rappbook/world-state/dimensions/{dimension_id}/
...
python3 scripts/merge-dimensions.py \
  ...
  --output CommunityRAPP/rappbook/world-state/current_tick.json
```
...
- `CommunityRAPP/rappbook/world-state/dimensions/{dim}/current_tick.json`
- `CommunityRAPP/rappbook/world-state/dimensions/{dim}/tick_history/`
