    ...
    def test_process_transcript_capital_markets(self, mock_openai_class):
        ...
        mock_json_response = json.dumps({
            "callMetadata": {
                ...
                "participants": [
                    {"name": "Demo Rep 2", "role": "Managing Director, Operations", "company": "Meridian Capital Partners"},
            ...
            "stakeholders": [
                {"name": "Demo Rep 2", "role": "Managing Director, Operations", "influenceLevel": "DECISION_MAKER", "concerns": ["ROI", "Q2 timeline"], "enthusiasm": "HIGH"}
            ],
            "successCriteria": [
