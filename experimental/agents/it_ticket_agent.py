...
class ITTicketAgent(BasicAgent):
    ...
    def _get_queue_status(self, params: Dict) -> str:
        ...
        queue_status = {
            ...
            "team_workload": [
                {"agent": "Demo Rep 2", "assigned": 8, "capacity": 10, "status": "Available"},
                {"agent": "Demo Rep 3", "assigned": 10, "capacity": 10, "status": "At Capacity"},
    ...
    def _escalate_ticket(self, ticket_id: str, params: Dict) -> str:
        ...
        escalation = {
            ...
            "notifications": [
                ...
                {"recipient": "Demo Exec 1", "message": "New L2 escalation assigned"},
