        ...
        return json.dumps({
            ...
            "account_brief": {
                ...
                "key_contacts": [
                    ...
                    {"name": "Demo VP", "title": "VP Operations", "relationship": "Champion", "sentiment": "Very Positive"},
                    {"name": "Demo Director", "title": "Procurement Director", "relationship": "Economic Buyer", "sentiment": "Neutral"}
                ],
            ...
            "ai_insight": "Contract renewal in 3 months - this is your expansion window. Demo VP is your champion; leverage her for executive access to close Plant Modernization."
        }, indent=2)
        ...
        return json.dumps({
            ...
            "meeting_preparation_brief": {
                ...
                "conversation_starters": [
                    ...
                    "I saw Demo Director posted about Industry 4.0 challenges - we have some interesting solutions there",
    ...
    def _relationship_map(self, account_name):
        return json.dumps({
            ...
            "relationship_map": {
                ...
                "relationship_gaps": [
                    "No relationship with CFO (Demo CFO) - needed for large deals",
                ...
                "internal_schneider_team": [
                    ...
                    {"name": "Demo Rep", "role": "Solution Architect", "specialty": "Industrial Automation"},
        ...
        return json.dumps({
            ...
            "news_and_signals": {
                ...
                "social_signals": [
                    ...
                    {"person": "Demo Director", "platform": "LinkedIn", "activity": "Posted about supply chain digitization challenges"}
                ],
                "hiring_signals": [
                ...
                "whitespace_opportunities": [
                    {
                        ...
                        "next_step": "Request intro from Demo VP",
                        "probability": "60%"
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "champion": "Demo VP (very interested)",
