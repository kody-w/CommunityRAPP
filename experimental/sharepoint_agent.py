...
class ContractAnalysisAgent(BasicAgent):
    ...
    def __init__(self):
        ...
        self.storage_account = os.environ.get('AZURE_STORAGE_ACCOUNT_NAME', 'YOUR_STORAGE_ACCOUNT')
        self.share_name = os.environ.get('AZURE_FILES_SHARE_NAME', 'azfYOUR_FUNCTION_APPov4bzgynnlvii')
