...
Deploy Copilot Entra Agent to Microsoft Teams and Microsoft 365 Copilot using Power Platform.
...
**Azure Resources:**
- Deployed Copilot Entra Agent Function App (see [Getting Started](GETTING_STARTED.md))
