...
Complete guide for deploying Copilot Entra Agent to production environments.
...
This guide covers production deployment strategies for Copilot Entra Agent, including:
...
az functionapp config appsettings set \
  ...
  --settings \
    ...
    "ASSISTANT_NAME=Copilot Entra Agent" \
