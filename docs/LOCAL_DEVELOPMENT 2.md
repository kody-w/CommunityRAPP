...
The Copilot Entra Agent system supports **environment-aware storage** that automatically adapts between Azure File Storage (for production) and local file system storage (for development).
